...
Y pues ya está. Con esto y un bizcocho hemos hecho un bypass en Windows saltándonos el proceso de login, hemos extraido las contraseñas del fichero SAM utilizando PwDump y hemos crackeado las contraseñas con John the Ripper.
