...
Normalmente los que se dedican al cracking de hashes suelen tener varios **Pc´s en cluster** y utilizan **procesadores para servidores** como el **Intel Xeon** para utilizar **varias GPU's** a la vez y aumentar la potencia de cómputo.
...
**Conclusión:** Si bien es cierto que la fuerza bruta no suele ser muy utilizada debido a la complejidad del asunto en cuanto a potencia de hardware se refiere, también es cierto que es una opción muy interesante que no se puede descartar a la hora de llevar a cabo auditorías de seguridad ya que si conocemos el charset las probabilidades de fallo son prácticamente nulas.
